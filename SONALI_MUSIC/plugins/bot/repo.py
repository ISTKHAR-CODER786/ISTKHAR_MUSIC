...
start_txt = """**
<u>❃ ᴡєʟᴄσϻє ᴛᴏ ᴛєᴧϻ ᴛʜᴜɴᴅᴇʀ ʀєᴘσs ❃</u>
 
✼ ʀєᴘᴏ ᴛᴏ ηʜɪ ϻɪʟєɢᴧ ʏʜᴧ
 
❉ ᴘᴧʜʟє ᴘᴧᴘᴧ ʙσʟ ʀєᴘᴏ ᴏᴡηєʀ ᴋᴏ 

✼ || [ɪsᴛᴋɢᴀʀ-ʙᴧʙʏ](https://t.me/ll_ISTKHAR_BABY_lll) ||
...
async def start(_, msg):
    buttons = [
        ...
        [
          ...
          InlineKeyboardButton("• 𝛅ᴜᴘᴘσʀᴛ •", url="https://t.me/THUNDERDEVS"),
          ],
[
InlineKeyboardButton("• ϻᴧɪη ʙσᴛ •", url=f"https://t.me/CrewMusic_bot"),
    ...
    await msg.reply_photo(
        photo="https://files.catbox.moe/og5233.jpg",
        caption=start_txt,
